...
// The following consts are a list of AlertIDs. All IDs used throughout TurtleDex
...
// AlertIDTurtleDexfileLowRedundancy uses a TurtleDexfile's UID to create a unique AlertID
// for a low redundancy alert.
func AlertIDTurtleDexfileLowRedundancy(uid string) AlertID {
