...
var (
	...
	bucketTurtleDexcoinOutputIDs = []byte("TurtleDexcoinOutputIDs")
	bucketTurtleDexcoinOutputs   = []byte("TurtleDexcoinOutputs")
	bucketTurtleDexfundOutputIDs = []byte("TurtleDexfundOutputIDs")
	bucketTurtleDexfundOutputs   = []byte("TurtleDexfundOutputs")
