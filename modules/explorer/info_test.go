...
func TestImmediateBlockFacts(t *testing.T) {
	...
	if !facts.TotalCoins.Equals(types.CalculateNumTurtleDexcoins(et.cs.Height())) {
...
func TestFileContractPayoutsMissingProof(t *testing.T) {
	...
	fc := types.FileContract{
		...
		WindowEnd:          windowEnd,
		Payout:             payout,
		ValidProofOutputs:  []types.TurtleDexcoinOutput{{Value: types.PostTax(et.cs.Height(), payout)}},
		MissedProofOutputs: []types.TurtleDexcoinOutput{{Value: types.PostTax(et.cs.Height(), payout)}},
