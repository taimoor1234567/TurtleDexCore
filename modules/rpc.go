...
type (
	...
	RPCRegistrySubscriptionRequest struct {
		PubKey types.TurtleDexPublicKey
		Tweak  crypto.Hash
	...
	RPCRenewContractCollateralResponse struct {
		...
		NewInputs   []types.TurtleDexcoinInput
		NewOutputs  []types.TurtleDexcoinOutput
		FinalRevSig crypto.Signature
	}
...
func (epr RPCExecuteProgramResponse) MarshalTurtleDex(w io.Writer) error {
	var errStr string
	if epr.Error != nil {
...
func (epr *RPCExecuteProgramResponse) UnmarshalTurtleDex(r io.Reader) error {
	var errStr string
...
func (resp *rpcResponse) MarshalTurtleDex(w io.Writer) error {
	if resp.data == nil {
		resp.data = struct{}{}
	}
...
func (resp *rpcResponse) UnmarshalTurtleDex(r io.Reader) error {
