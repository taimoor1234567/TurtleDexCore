...
var (
	...
	// defaultCollateralBudget defines the maximum number of ttdcs that the
	...
	defaultCollateralBudget = types.TurtleDexcoinPrecision.Mul64(100e3)
	...
	defaultMaxEphemeralAccountRisk = types.TurtleDexcoinPrecision.Mul64(5)
