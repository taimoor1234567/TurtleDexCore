...
func TestVerifyRenewedContract(t *testing.T) {
	...
	pt := &modules.RPCPriceTable{
		...
		MaxCollateral:     types.TurtleDexcoinPrecision.Mul64(100),
		ContractPrice:     types.TurtleDexcoinPrecision,
		MaxDuration:       100,
		WriteStoreCost:    types.NewCurrency64(1),
		WindowSize:        10,
		RenewContractCost: types.TurtleDexcoinPrecision,
	}
	...
	oldRevision := types.FileContractRevision{
		...
		NewValidProofOutputs: []types.TurtleDexcoinOutput{
			{
				...
				Value:      types.TurtleDexcoinPrecision.Mul64(10),
			},
			{
				UnlockHash: types.UnlockHash{2},
				Value:      types.TurtleDexcoinPrecision.Mul64(20),
			},
		},
		NewMissedProofOutputs: []types.TurtleDexcoinOutput{
			...
			{
				UnlockHash: types.UnlockHash{2},
				Value:      types.TurtleDexcoinPrecision.Mul64(20).Sub64(1),
			},
			{
	...
	goodFC := fc
	goodFC.ValidProofOutputs = append([]types.TurtleDexcoinOutput{}, goodFC.ValidProofOutputs...)
	...
	badFC = fc
	badFC.ValidProofOutputs = append([]types.TurtleDexcoinOutput{}, badFC.ValidProofOutputs...)
	...
	badFC = fc
	badFC.MissedProofOutputs = append([]types.TurtleDexcoinOutput{}, badFC.MissedProofOutputs...)
	...
	goodFC = fc
	goodFC.ValidProofOutputs = append([]types.TurtleDexcoinOutput{}, goodFC.ValidProofOutputs...)
	goodFC.MissedProofOutputs = append([]types.TurtleDexcoinOutput{}, goodFC.MissedProofOutputs...)
