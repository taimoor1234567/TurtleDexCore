...
func (h *Host) managedAddCollateral(settings modules.HostExternalSettings, txnSet []types.Transaction) (builder modules.TransactionBuilder, newParents []types.Transaction, newInputs []types.TurtleDexcoinInput, newOutputs []types.TurtleDexcoinOutput, err error) {
	...
	err = builder.FundTurtleDexcoins(hostPortion)
	if err != nil {
		builder.Drop()
