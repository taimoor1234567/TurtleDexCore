...
func assertSubscriptionInfos(host *Host, spk types.TurtleDexPublicKey, tweak crypto.Hash, n int) ([]*subscriptionInfo, error) {
...
func readAndAssertRegistryValueNotification(spk types.TurtleDexPublicKey, rv modules.SignedRegistryValue, r io.Reader) error {
