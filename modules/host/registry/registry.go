...
// tweak.
func valueMapKey(key types.TurtleDexPublicKey, tweak crypto.Hash) crypto.Hash {
...
func (r *Registry) Get(pubKey types.TurtleDexPublicKey, tweak crypto.Hash) (modules.SignedRegistryValue, bool) {
	r.mu.Lock()
...
func (r *Registry) Update(rv modules.SignedRegistryValue, pubKey types.TurtleDexPublicKey, expiry types.BlockHeight) (srv modules.SignedRegistryValue, _ error) {
...
func (r *Registry) newValue(rv modules.SignedRegistryValue, pubKey types.TurtleDexPublicKey, expiry types.BlockHeight) (*value, error) {
