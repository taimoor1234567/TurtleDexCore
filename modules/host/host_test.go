...
type renterHostPair struct {
	...
	staticRenterPK   types.TurtleDexPublicKey
	staticRenterMux  *siamux.TurtleDexMux
	staticHT         *hostTester
...
func newRenterHostPairCustomHostTester(ht *hostTester) (*renterHostPair, error) {
	...
	renterPK := types.TurtleDexPublicKey{
...
func (p *renterHostPair) managedNewStream() siamux.Stream {
	pk := modules.TurtleDexPKToMuxPK(p.staticHT.host.publicKey)
	address := p.staticHT.host.ExternalSettings().TurtleDexMuxAddress()
	subscriber := modules.HostTurtleDexMuxSubscriberName
...
func (p *renterHostPair) ProvidePayment(stream io.ReadWriter, _ types.TurtleDexPublicKey, rpc types.Specifier, amount types.Currency, refundAccount modules.AccountID, blockHeight types.BlockHeight) error {
	// Send the payment request.
...
func (p *renterHostPair) SubcribeToRV(stream siamux.Stream, pt *modules.RPCPriceTable, pubkey types.TurtleDexPublicKey, tweak crypto.Hash) (*modules.SignedRegistryValue, error) {
...
func (p *renterHostPair) UnsubcribeFromRV(stream siamux.Stream, pt *modules.RPCPriceTable, pubkey types.TurtleDexPublicKey, tweak crypto.Hash) error {
