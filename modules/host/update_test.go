...
func TestStorageProof(t *testing.T) {
	...
	fc := types.FileContract{
		...
		ValidProofOutputs:  []types.TurtleDexcoinOutput{{Value: types.NewCurrency64(1)}, {Value: types.NewCurrency64(0)}},
		MissedProofOutputs: []types.TurtleDexcoinOutput{{Value: types.NewCurrency64(1)}, {Value: types.NewCurrency64(0)}},
	}
