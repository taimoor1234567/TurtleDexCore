...
func TestPriceTableMarshaling(t *testing.T) {
	pt := modules.RPCPriceTable{
		...
		UpdatePriceTableCost: types.TurtleDexcoinPrecision,
		InitBaseCost:         types.TurtleDexcoinPrecision.Mul64(1e2),
		MemoryTimeCost:       types.TurtleDexcoinPrecision.Mul64(1e3),
		ReadBaseCost:         types.TurtleDexcoinPrecision.Mul64(1e4),
		ReadLengthCost:       types.TurtleDexcoinPrecision.Mul64(1e5),
		HasSectorBaseCost:    types.TurtleDexcoinPrecision.Mul64(1e6),
		TxnFeeMinRecommended: types.TurtleDexcoinPrecision.Mul64(1e7),
		TxnFeeMaxRecommended: types.TurtleDexcoinPrecision.Mul64(1e8),
		DropSectorsBaseCost:  types.TurtleDexcoinPrecision.Mul64(1e9),
		DropSectorsUnitCost:  types.TurtleDexcoinPrecision.Mul64(1e10),
		WriteBaseCost:        types.TurtleDexcoinPrecision.Mul64(1e11),
		WriteLengthCost:      types.TurtleDexcoinPrecision.Mul64(1e12),
		WriteStoreCost:       types.TurtleDexcoinPrecision.Mul64(1e13),
		LatestRevisionCost:   types.TurtleDexcoinPrecision.Mul64(1e14),
		FundAccountCost:      types.TurtleDexcoinPrecision.Mul64(1e15),
		AccountBalanceCost:   types.TurtleDexcoinPrecision.Mul64(1e16),
		SwapSectorCost:       types.TurtleDexcoinPrecision.Mul64(1e17),
	}
