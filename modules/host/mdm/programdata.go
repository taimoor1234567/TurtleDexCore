...
// TurtleDexPublicKey reads a types.TurtleDexPublicKey from the programData. Given an offset
// and a key length. The length includes the specifier size.
func (pd *programData) TurtleDexPublicKey(offset, length uint64) (types.TurtleDexPublicKey, error) {
