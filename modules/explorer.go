...
type (
	...
	BlockFacts struct {
		...
		TurtleDexcoinInputCount         uint64 `json:"ttdcinputcount"`
		TurtleDexcoinOutputCount        uint64 `json:"ttdcoutputcount"`
		...
		TurtleDexfundInputCount         uint64 `json:"siafundinputcount"`
		TurtleDexfundOutputCount        uint64 `json:"siafundoutputcount"`
	...
	Explorer interface {
		...
		// TurtleDexcoinOutput will return the ttdc output associated with the
		// input id.
		TurtleDexcoinOutput(types.TurtleDexcoinOutputID) (types.TurtleDexcoinOutput, bool)

		// TurtleDexcoinOutputID returns all of the transaction ids associated with
		// the provided ttdc output id.
		TurtleDexcoinOutputID(types.TurtleDexcoinOutputID) []types.TransactionID
		...
		// TurtleDexfundOutput will return the siafund output associated with the
		// input id.
		TurtleDexfundOutput(types.TurtleDexfundOutputID) (types.TurtleDexfundOutput, bool)

		// TurtleDexfundOutputID returns all of the transaction ids associated with
		// the provided siafund output id.
		TurtleDexfundOutputID(types.TurtleDexfundOutputID) []types.TransactionID
