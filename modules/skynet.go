...
type (
	...
	SkyfileUploadParameters struct {
		// TurtleDexPath defines the siapath that the skyfile is going to be uploaded
		...
		// file to the TurtleDex network.
		DryRun bool

		// Force determines whether the upload should overwrite an existing
		// siafile at 'TurtleDexPath'. If set to false, an error will be returned if
		// there is already a file or folder at 'TurtleDexPath'. If set to true, any
		// existing file or folder at 'TurtleDexPath' will be deleted and overwritten.
		Force bool
