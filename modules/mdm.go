...
// key value pair.
func RegistrySubscriptionID(pubKey types.TurtleDexPublicKey, tweak crypto.Hash) SubscriptionID {
...
func MDMCopyCost(pt RPCPriceTable, contractSize uint64) types.Currency {
	return types.TurtleDexcoinPrecision // TODO: figure out good cost
}
