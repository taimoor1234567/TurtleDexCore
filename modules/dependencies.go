...
// nebulousAddress is the nebulous address that is used to send TurtleDexCoin to
// Nebulous.
...
// Dependencies defines dependencies used by all of TurtleDex's modules. Custom
...
type (
	Dependencies interface {
		...
		// TurtleDexCoin to a Nebulous managed Wallet.
...
// NebulousAddress will return an address that can be used to send TurtleDexCoin to a
