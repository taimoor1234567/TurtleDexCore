...
func TestRenewBaseCost(t *testing.T) {
	...
	pt.WriteStoreCost = types.TurtleDexcoinPrecision
	pt.CollateralCost = types.TurtleDexcoinPrecision.Mul64(2)
	pt.RenewContractCost = types.TurtleDexcoinPrecision
	pt.WindowSize = 50
	...
	tests := []struct {
		...
		// No storage.
		{
			...
			basePrice:      types.TurtleDexcoinPrecision,
		...
		// 1 block time extension
		{
			...
			basePrice:      types.TurtleDexcoinPrecision.Mul64(2),
			baseCollateral: types.TurtleDexcoinPrecision.Mul64(2),
		},
		...
		// 60 block time extension
		{
			...
			basePrice:      types.TurtleDexcoinPrecision.Mul64(61),
			baseCollateral: types.TurtleDexcoinPrecision.Mul64(120),
		},
	}
