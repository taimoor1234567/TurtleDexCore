...
type (
	...
	account struct {
		...
		staticHostKey   types.TurtleDexPublicKey
...
func (a *account) ProvidePayment(stream io.ReadWriter, _ types.TurtleDexPublicKey, rpc types.Specifier, amount types.Currency, refundAccount modules.AccountID, blockHeight types.BlockHeight) error {
