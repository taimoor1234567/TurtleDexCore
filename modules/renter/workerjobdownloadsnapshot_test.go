...
func TestCheckDownloadSnapshotGouging(t *testing.T) {
	...
	allowance.Funds = types.TurtleDexcoinPrecision.Mul64(1e3)
	...
	gougingPriceTable.InitBaseCost = types.TurtleDexcoinPrecision
	gougingPriceTable.ReadBaseCost = types.TurtleDexcoinPrecision
