...
// we think this is a new account, some previous run on ttdxd may have created
// the account for us.
//
...
func (am *accountManager) managedOpenAccount(hostKey types.TurtleDexPublicKey) (acc *account, err error) {
