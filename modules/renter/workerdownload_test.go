...
func TestCheckDownloadGouging(t *testing.T) {
	...
	minAllowance := modules.Allowance{
		...
		Funds: types.TurtleDexcoinPrecision.Mul64(3).Div64(downloadGougingFractionDenom).Sub(oneCurrency),
	...
	minPriceTable := &modules.RPCPriceTable{
		ReadBaseCost:          types.TurtleDexcoinPrecision,
		ReadLengthCost:        types.TurtleDexcoinPrecision.Div64(modules.StreamDownloadSize),
		DownloadBandwidthCost: types.TurtleDexcoinPrecision.Div64(modules.StreamDownloadSize),
	}
