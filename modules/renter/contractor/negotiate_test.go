...
import (
	...
	modWallet "github.com/turtledex/TurtleDexCore/modules/wallet" // name conflicts with type
...
func TestNegotiateContract(t *testing.T) {
	...
	err = txnBuilder.FundTurtleDexcoins(fc.Payout)
	if err != nil {
		t.Fatal(err)
	}
...
func TestReviseContract(t *testing.T) {
	...
	renterPubKey := types.TurtleDexPublicKey{
		Algorithm: types.SignatureEd25519,
		Key:       pk[:],
	}

	uc := types.UnlockConditions{
		PublicKeys:         []types.TurtleDexPublicKey{renterPubKey, renterPubKey},
	...
	fc.ValidProofOutputs = []types.TurtleDexcoinOutput{
	...
	fc.MissedProofOutputs = []types.TurtleDexcoinOutput{
		// same as above
