...
// child contract.
func (c *Contractor) managedContractByPublicKey(pk types.TurtleDexPublicKey) (modules.RenterContract, bool) {
	c.mu.RLock()
...
// contract.
func (c *Contractor) ContractByPublicKey(pk types.TurtleDexPublicKey) (modules.RenterContract, bool) {
...
func (c *Contractor) ContractUtility(pk types.TurtleDexPublicKey) (modules.ContractUtility, bool) {
	c.mu.RLock()
	id, ok := c.pubKeysToContractID[pk.String()]
	c.mu.RUnlock()
	if !ok {
