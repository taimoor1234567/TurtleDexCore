...
abstraction. Ideally, the renter should be mostly ignorant of the TurtleDex protocol,
...
The Contractor is also responsible for scanning the TurtleDex blockchain and
...
Currently it uses the TurtleDex persist package. Prior to v1.3.0 the persistence
...
also monitors all the parent TurtleDexcoin outputs used in the creation of the
