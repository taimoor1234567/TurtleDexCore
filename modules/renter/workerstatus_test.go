...
func TestWorkerRegistryJobStatus(t *testing.T) {
	...
	jrr := w.newJobReadRegistry(ctx, rrc, types.TurtleDexPublicKey{}, crypto.Hash{})
	jur := w.newJobUpdateRegistry(ctx, urc, types.TurtleDexPublicKey{}, modules.SignedRegistryValue{})
