...
func (h *contractHeader) HostPublicKey() types.TurtleDexPublicKey {
...
func (c *SafeContract) Metadata() modules.RenterContract {
	...
	return modules.RenterContract{
		...
		TxnFee:           h.TxnFee,
		TurtleDexfundFee:       h.TurtleDexfundFee,
		Utility:          h.Utility,
	}
}
...
func (cs *ContractSet) ConvertV130Contract(c V130Contract, cr V130CachedRevision) error {
	m, err := cs.managedInsertContract(contractHeader{
		...
		TxnFee:           c.TxnFee,
		TurtleDexfundFee:       c.TurtleDexfundFee,
	}, c.MerkleRoots)
	if err != nil {
		return err
	}
...
type V130Contract struct {
	...
	TurtleDexfundFee       types.Currency             `json:"siafundfee"`
}
