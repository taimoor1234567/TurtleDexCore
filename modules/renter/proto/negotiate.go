...
func verifySettings(conn net.Conn, host modules.HostDBEntry) (modules.HostDBEntry, error) {
	// convert host key (types.TurtleDexPublicKey) to a crypto.PublicKey
...
func performSessionHandshake(conn net.Conn, hostPublicKey types.TurtleDexPublicKey) (cipher.AEAD, modules.LoopChallengeRequest, error) {
