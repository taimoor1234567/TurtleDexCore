...
const (
	...
	updateInsertName = "TurtleDexFileInsert"

	// updateDeleteName is the name of a siaFile update that deletes the
	// specified file.
	updateDeleteName = "TurtleDexFileDelete"
	...
	// pubKeyTablePruneThreshold is the number of unused hosts a TurtleDexFile can
...
// IsTurtleDexFileUpdate is a helper method that makes sure that a wal update belongs
// to the TurtleDexFile package.
func IsTurtleDexFileUpdate(update writeaheadlog.Update) bool {
	switch update.Name {
