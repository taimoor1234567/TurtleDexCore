...
type (
	...
	worker struct {
		...
		staticHostPubKey    types.TurtleDexPublicKey
...
func (r *Renter) newWorker(hostPubKey types.TurtleDexPublicKey) (*worker, error) {
	...
	balanceTarget := types.TurtleDexcoinPrecision
