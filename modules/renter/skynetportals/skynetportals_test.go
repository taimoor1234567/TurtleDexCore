...
// TestMarshalTurtleDex probes the marshalTurtleDex and unmarshalTurtleDex methods
func TestMarshalTurtleDex(t *testing.T) {
	// Test MarshalTurtleDex
	portal := modules.SkynetPortal{
	...
	// Test UnmarshalTurtleDex, portals should unmarshal in the order they were
	// marshalled.
	r := bytes.NewBuffer(buf.Bytes())
	err = pe.UnmarshalTurtleDex(r)
	if err != nil {
		t.Fatal(err)
	}
