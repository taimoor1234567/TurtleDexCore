...
func (ht *HostTree) Remove(pk types.TurtleDexPublicKey) error {
	ht.mu.Lock()
	defer ht.mu.Unlock()
...
func (ht *HostTree) SetFiltered(pubKey types.TurtleDexPublicKey, filtered bool) error {
...
func (ht *HostTree) Select(spk types.TurtleDexPublicKey) (modules.HostDBEntry, bool) {
	ht.mu.Lock()
	defer ht.mu.Unlock()
...
// used.
func (ht *HostTree) SelectRandom(n int, blacklist, addressBlacklist []types.TurtleDexPublicKey) []modules.HostDBEntry {
	ht.mu.Lock()
	defer ht.mu.Unlock()
