...
func (hdb *HostDB) IncrementSuccessfulInteractions(key types.TurtleDexPublicKey) error {
...
func (hdb *HostDB) IncrementFailedInteractions(key types.TurtleDexPublicKey) error {
	if err := hdb.tg.Add(); err != nil {
		return errors.AddContext(err, "error adding hostdb threadgroup:")
	}
	defer hdb.tg.Done()
