...
func (hdb *HostDB) RandomHosts(n int, blacklist, addressBlacklist []types.TurtleDexPublicKey) ([]modules.HostDBEntry, error) {
	hdb.mu.RLock()
...
func (hdb *HostDB) RandomHostsWithAllowance(n int, blacklist, addressBlacklist []types.TurtleDexPublicKey, allowance modules.Allowance) ([]modules.HostDBEntry, error) {
	hdb.mu.RLock()
	initialScanComplete := hdb.initialScanComplete
