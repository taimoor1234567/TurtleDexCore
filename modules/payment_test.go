...
func TestNewAccountID(t *testing.T) {
	...
	// verify the account ID is valid by converting it to a TurtleDexPublicKey
	_ = aid.SPK()
...
func TestAccountID_FromSPK(t *testing.T) {
	...
	aid.FromSPK(types.TurtleDexPublicKey{})
	if !aid.IsZeroAccount() {
...
// TestAccountID_MarshalTurtleDex tests the TurtleDexMarshaler implementation.
func TestAccountID_MarshalTurtleDex(t *testing.T) {
	t.Parallel()
	spk := types.TurtleDexPublicKey{
		Algorithm: types.SignatureEd25519,
		Key:       fastrand.Bytes(32),
...
// TestAccountIDCompatTurtleDexMarshal makes sure that the persistence data of a
// TurtleDexPublicKey matches the data of a AccountID.
func TestAccountIDCompatTurtleDexMarhsal(t *testing.T) {
	t.Parallel()
	spk := types.TurtleDexPublicKey{
		Algorithm: types.SignatureEd25519,
		Key:       fastrand.Bytes(32),
