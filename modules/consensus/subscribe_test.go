...
func TestPerBlockDiffs(t *testing.T) {
	...
	for _, cc := range ms.updates {
		...
		for _, diff := range cc.RevertedDiffs {
			ccd.TurtleDexcoinOutputDiffs = append(ccd.TurtleDexcoinOutputDiffs, diff.TurtleDexcoinOutputDiffs...)
			ccd.FileContractDiffs = append(ccd.FileContractDiffs, diff.FileContractDiffs...)
			ccd.TurtleDexfundOutputDiffs = append(ccd.TurtleDexfundOutputDiffs, diff.TurtleDexfundOutputDiffs...)
			ccd.DelayedTurtleDexcoinOutputDiffs = append(ccd.DelayedTurtleDexcoinOutputDiffs, diff.DelayedTurtleDexcoinOutputDiffs...)
			ccd.TurtleDexfundPoolDiffs = append(ccd.TurtleDexfundPoolDiffs, diff.TurtleDexfundPoolDiffs...)
		}
