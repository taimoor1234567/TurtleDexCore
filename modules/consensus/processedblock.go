...
type processedBlock struct {
	...
	DiffsGenerated            bool
	TurtleDexcoinOutputDiffs        []modules.TurtleDexcoinOutputDiff
	FileContractDiffs         []modules.FileContractDiff
	TurtleDexfundOutputDiffs        []modules.TurtleDexfundOutputDiff
	DelayedTurtleDexcoinOutputDiffs []modules.DelayedTurtleDexcoinOutputDiff
	TurtleDexfundPoolDiffs          []modules.TurtleDexfundPoolDiff
