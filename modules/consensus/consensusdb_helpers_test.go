...
// dbGetTurtleDexcoinOutput is a convenience function allowing getTurtleDexcoinOutput to be
// called without a bolt.Tx.
func (cs *ConsensusSet) dbGetTurtleDexcoinOutput(id types.TurtleDexcoinOutputID) (sco types.TurtleDexcoinOutput, err error) {
	dbErr := cs.db.View(func(tx *bolt.Tx) error {
...
// getArbTurtleDexcoinOutput is a convenience function fetching a single random
// ttdc output from the database.
func (cs *ConsensusSet) getArbTurtleDexcoinOutput() (scoid types.TurtleDexcoinOutputID, sco types.TurtleDexcoinOutput, err error) {
	dbErr := cs.db.View(func(tx *bolt.Tx) error {
		cursor := tx.Bucket(TurtleDexcoinOutputs).Cursor()
...
// dbGetTurtleDexfundOutput is a convenience function allowing getTurtleDexfundOutput to be
// called without a bolt.Tx.
func (cs *ConsensusSet) dbGetTurtleDexfundOutput(id types.TurtleDexfundOutputID) (sfo types.TurtleDexfundOutput, err error) {
	dbErr := cs.db.View(func(tx *bolt.Tx) error {
		sfo, err = getTurtleDexfundOutput(tx, id)
		return nil
	})
	if dbErr != nil {
		panic(dbErr)
...
// dbAddTurtleDexfundOutput is a convenience function allowing addTurtleDexfundOutput to be
// called without a bolt.Tx.
func (cs *ConsensusSet) dbAddTurtleDexfundOutput(id types.TurtleDexfundOutputID, sfo types.TurtleDexfundOutput) {
	dbErr := cs.db.Update(func(tx *bolt.Tx) error {
		addTurtleDexfundOutput(tx, id, sfo)
		return nil
	})
	if dbErr != nil {
		panic(dbErr)
...
// dbGetTurtleDexfundPool is a convenience function allowing getTurtleDexfundPool to be
// called without a bolt.Tx.
func (cs *ConsensusSet) dbGetTurtleDexfundPool() (siafundPool types.Currency) {
	dbErr := cs.db.View(func(tx *bolt.Tx) error {
...
// dbGetDSCO is a convenience function allowing a delayed ttdc output to be
...
func (cs *ConsensusSet) dbGetDSCO(height types.BlockHeight, id types.TurtleDexcoinOutputID) (dsco types.TurtleDexcoinOutput, err error) {
	dbErr := cs.db.View(func(tx *bolt.Tx) error {
