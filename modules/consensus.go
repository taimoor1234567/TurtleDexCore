...
type (
	...
	// would have one TurtleDexcoinOutputDiff with direction DiffRevert and one
	// DelayedTurtleDexcoinOutputDiff with direction DiffApply. If the same block
	...
	ConsensusChangeDiffs struct {
		TurtleDexcoinOutputDiffs        []TurtleDexcoinOutputDiff
		FileContractDiffs         []FileContractDiff
		TurtleDexfundOutputDiffs        []TurtleDexfundOutputDiff
		DelayedTurtleDexcoinOutputDiffs []DelayedTurtleDexcoinOutputDiff
		TurtleDexfundPoolDiffs          []TurtleDexfundPoolDiff
	}
	...
	// A TurtleDexcoinOutputDiff indicates the addition or removal of a TurtleDexcoinOutput in
	// the consensus set.
	TurtleDexcoinOutputDiff struct {
		Direction     DiffDirection
		ID            types.TurtleDexcoinOutputID
	...
	// A TurtleDexfundOutputDiff indicates the addition or removal of a TurtleDexfundOutput in
	// the consensus set.
	TurtleDexfundOutputDiff struct {
		Direction     DiffDirection
		ID            types.TurtleDexfundOutputID
		TurtleDexfundOutput types.TurtleDexfundOutput
	}

	// A DelayedTurtleDexcoinOutputDiff indicates the introduction of a ttdc output
	// that cannot be spent until after maturing for 144 blocks. When the output
	// has matured, a TurtleDexcoinOutputDiff will be provided.
	DelayedTurtleDexcoinOutputDiff struct {
		Direction      DiffDirection
		ID             types.TurtleDexcoinOutputID
		TurtleDexcoinOutput  types.TurtleDexcoinOutput
	...
	// A TurtleDexfundPoolDiff contains the value of the siafundPool before the block
...
func (cc *ConsensusChange) AppendDiffs(diffs ConsensusChangeDiffs) {
	cc.TurtleDexcoinOutputDiffs = append(cc.TurtleDexcoinOutputDiffs, diffs.TurtleDexcoinOutputDiffs...)
	cc.FileContractDiffs = append(cc.FileContractDiffs, diffs.FileContractDiffs...)
	cc.TurtleDexfundOutputDiffs = append(cc.TurtleDexfundOutputDiffs, diffs.TurtleDexfundOutputDiffs...)
	cc.DelayedTurtleDexcoinOutputDiffs = append(cc.DelayedTurtleDexcoinOutputDiffs, diffs.DelayedTurtleDexcoinOutputDiffs...)
	cc.TurtleDexfundPoolDiffs = append(cc.TurtleDexfundPoolDiffs, diffs.TurtleDexfundPoolDiffs...)
}

// MarshalTurtleDex implements encoding.TurtleDexMarshaler.
func (cc ConsensusChange) MarshalTurtleDex(w io.Writer) error {
...
// UnmarshalTurtleDex implements encoding.TurtleDexUnmarshaler.
func (cc *ConsensusChange) UnmarshalTurtleDex(r io.Reader) error {
