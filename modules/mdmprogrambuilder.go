...
func (pb *ProgramBuilder) AddUpdateRegistryInstruction(spk types.TurtleDexPublicKey, rv SignedRegistryValue) error {
	// Marshal pubKey.
...
func (pb *ProgramBuilder) V154AddUpdateRegistryInstruction(spk types.TurtleDexPublicKey, rv SignedRegistryValue) error {
	// Marshal pubKey.
	pk := encoding.Marshal(spk)
	// Compute the argument offsets.
	tweakOff := uint64(pb.programData.Len())
...
func (pb *ProgramBuilder) V154AddReadRegistryInstruction(spk types.TurtleDexPublicKey, tweak crypto.Hash) (types.Currency, error) {
	// Marshal pubKey.
	pk := encoding.Marshal(spk)
	// Compute the argument offsets.
...
func (pb *ProgramBuilder) AddReadRegistryInstruction(spk types.TurtleDexPublicKey, tweak crypto.Hash) (types.Currency, error) {
	// Marshal pubKey.
	pk := encoding.Marshal(spk)
	// Compute the argument offsets.
	pubKeyOff := uint64(pb.programData.Len())
