...
type (
	...
	// SendTurtleDexcoins and SendTurtleDexcoinsMulti to fail before AcceptTransactionSet
	// is called
	dependencySendTurtleDexcoinsInterrupted struct {
...
func (d *dependencySendTurtleDexcoinsInterrupted) Disrupt(s string) bool {
	if d.f && s == "SendTurtleDexcoinsInterrupted" {
		d.f = false
		return true
	}
	return false
...
// fail causes the next SendTurtleDexcoinsInterrupted disrupt to return true
func (d *dependencySendTurtleDexcoinsInterrupted) fail() {
	d.f = true
}
