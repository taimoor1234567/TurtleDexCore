...
var (
	...
	// bucketTurtleDexcoinOutputs maps a TurtleDexcoinOutputID to its TurtleDexcoinOutput. Only
	// outputs that the wallet controls are stored. The wallet uses these
	// outputs to fund transactions.
	bucketTurtleDexcoinOutputs = []byte("bucketTurtleDexcoinOutputs")
	// bucketTurtleDexcoinOutputs maps a TurtleDexfundOutputID to its TurtleDexfundOutput. Only
	// outputs that the wallet controls are stored. The wallet uses these
	// outputs to fund transactions.
	bucketTurtleDexfundOutputs = []byte("bucketTurtleDexfundOutputs")
	...
	dbBuckets = [][]byte{
		...
		bucketTurtleDexcoinOutputs,
		bucketTurtleDexfundOutputs,
		bucketSpentOutputs,
	...
	keyTurtleDexfundPool            = []byte("keyTurtleDexfundPool")
...
func dbReset(tx *bolt.Tx) error {
	...
	dbPutTurtleDexfundPool(tx, types.ZeroCurrency)
...
func dbPutTurtleDexcoinOutput(tx *bolt.Tx, id types.TurtleDexcoinOutputID, output types.TurtleDexcoinOutput) error {
	return dbPut(tx.Bucket(bucketTurtleDexcoinOutputs), id, output)
}
func dbDeleteTurtleDexcoinOutput(tx *bolt.Tx, id types.TurtleDexcoinOutputID) error {
	return dbDelete(tx.Bucket(bucketTurtleDexcoinOutputs), id)
}
func dbForEachTurtleDexcoinOutput(tx *bolt.Tx, fn func(types.TurtleDexcoinOutputID, types.TurtleDexcoinOutput)) error {
	return dbForEach(tx.Bucket(bucketTurtleDexcoinOutputs), fn)
}

func dbPutTurtleDexfundOutput(tx *bolt.Tx, id types.TurtleDexfundOutputID, output types.TurtleDexfundOutput) error {
	return dbPut(tx.Bucket(bucketTurtleDexfundOutputs), id, output)
}
func dbDeleteTurtleDexfundOutput(tx *bolt.Tx, id types.TurtleDexfundOutputID) error {
	return dbDelete(tx.Bucket(bucketTurtleDexfundOutputs), id)
}
func dbForEachTurtleDexfundOutput(tx *bolt.Tx, fn func(types.TurtleDexfundOutputID, types.TurtleDexfundOutput)) error {
	return dbForEach(tx.Bucket(bucketTurtleDexfundOutputs), fn)
}
...
// dbGetTurtleDexfundPool returns the value of the siafund pool.
func dbGetTurtleDexfundPool(tx *bolt.Tx) (pool types.Currency, err error) {
	err = encoding.Unmarshal(tx.Bucket(bucketWallet).Get(keyTurtleDexfundPool), &pool)
	return
}

// dbPutTurtleDexfundPool stores the value of the siafund pool.
func dbPutTurtleDexfundPool(tx *bolt.Tx, pool types.Currency) error {
	return tx.Bucket(bucketWallet).Put(keyTurtleDexfundPool, encoding.Marshal(pool))
}
