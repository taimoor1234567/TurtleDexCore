...
echo "$0 builds TurtleDex in a reproducible Docker build environment"
...
docker cp build-container:/home/builder/TurtleDex/release/ ../
...
cat ../release/TurtleDex-${versionName}-SHA256SUMS.txt
