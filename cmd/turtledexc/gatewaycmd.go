...
For example: ttdxc gateway blocklist append 123.123.123.123 111.222.111.222 mysiahost.duckdns.org`,
	...
	For example: ttdxc gateway blocklist clear`,
...
For example: ttdxc gateway blocklist remove 123.123.123.123 111.222.111.222 mysiahost.duckdns.org`,
...
For example: ttdxc gateway blocklist set 123.123.123.123 111.222.111.222 mysiahost.duckdns.org`,
...
// gatewayconnectcmd is the handler for the command `ttdxc gateway add [address]`.
...
// gatewaydisconnectcmd is the handler for the command `ttdxc gateway remove [address]`.
...
// gatewayaddresscmd is the handler for the command `ttdxc gateway address`.
...
//gatewaybandwidthcmd is the handler for the command `ttdxc gateway bandwidth`.
...
// gatewaycmd is the handler for the command `ttdxc gateway`.
...
// gatewayblocklistcmd is the handler for the command `ttdxc gateway blocklist`
...
// `ttdxc gateway blocklist append`
...
// `ttdxc gateway blocklist remove`
...
// gatewaylistcmd is the handler for the command `ttdxc gateway list`.
...
// gatewayratelimitcmd is the handler for the command `ttdxc gateway ratelimit`.
