...
// minerstartcmd is the handler for the command `ttdxc miner start`.
...
// minercmd is the handler for the command `ttdxc miner`.
...
// minerstopcmd is the handler for the command `ttdxc miner stop`.
// Stops the CPU miner.
func minerstopcmd() {
