...
func TestApplyAndFormat(t *testing.T) {
	...
	tests := []struct {
		...
		{mustParse("1 USD"), TurtleDexcoinPrecision, "~ 1.00 USD"},
		{mustParse("1 USD"), TurtleDexcoinPrecision.Div64(2), "~ 0.50 USD"},
		{mustParse("1 USD"), TurtleDexcoinPrecision.Mul64(10), "~ 10.00 USD"},
		{mustParse("0.12 USD"), TurtleDexcoinPrecision, "~ 0.12 USD"},
		{mustParse("0.1234 USD"), TurtleDexcoinPrecision, "~ 0.12 USD"},
		{mustParse("0.009 USD"), TurtleDexcoinPrecision, "~ 0.009 USD"},
		{mustParse("0.0094 USD"), TurtleDexcoinPrecision, "~ 0.009 USD"},
		{mustParse("0.0002 USD"), TurtleDexcoinPrecision, "~ 0.0002 USD"},
		{mustParse("0.00005 USD"), TurtleDexcoinPrecision, "~ 0.0001 USD"},
		{mustParse("0.00004 USD"), TurtleDexcoinPrecision, "~ 0.0000 USD"},
		{mustParse("0.0000001 USD"), TurtleDexcoinPrecision, "~ 0.0000 USD"},
		{mustParse("10.00004 USD"), TurtleDexcoinPrecision, "~ 10.00 USD"},
		{mustParse("0.0039 USD"), TurtleDexcoinPrecision.Mul64(1000), "~ 3.90 USD"},
		{mustParse("0.0039 USD"), TurtleDexcoinPrecision.Mul64(10000), "~ 39.00 USD"},
		{mustParse("1.23 EUR"), TurtleDexcoinPrecision, "~ 1.23 EUR"},
		...
		{mustParse("9.99999 USD"), TurtleDexcoinPrecision, "~ 10.00 USD"},
		{mustParse("1.11111 USD"), TurtleDexcoinPrecision, "~ 1.11 USD"},
	}
	for _, test := range tests {
