...
ldflags= -X github.com/turtledex/TurtleDexCore/build.GitRevision=${GIT_DIRTY}${GIT_REVISION} \
-X "github.com/turtledex/TurtleDexCore/build.BuildTime=${BUILD_TIME}"
...
pkgs = \
	...
	./modules/renter/filesystem/ttdxdir \
...
release-pkgs = ./cmd/ttdxc ./cmd/ttdxd
...
# and lint ttdxc/ttdxd locally and in CI systems.
dependencies:
	go get -d ./...
