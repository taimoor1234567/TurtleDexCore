...
func TestEstimateWeight(t *testing.T) {
	...
	is.MinContractPrice = is.MinContractPrice.Add(types.TurtleDexcoinPrecision.Mul64(9999999999))
	...
	for i, tester := range sts {
		...
		is.MinContractPrice = types.TurtleDexcoinPrecision.Mul64(1000 + (1000 * uint64(i)))
	...
	tests := []struct {
		...
		{types.TurtleDexcoinPrecision, 100},
		{types.TurtleDexcoinPrecision.Mul64(50), 98},
		{types.TurtleDexcoinPrecision.Mul64(2500), 10},
		{types.TurtleDexcoinPrecision.Mul64(3000), 1},
		{types.TurtleDexcoinPrecision.Mul64(30000), 0.00001},
	}
