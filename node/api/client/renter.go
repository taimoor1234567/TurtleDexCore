...
// escapeTurtleDexPath escapes the siapath to make it safe to use within a URL. This
// should only be used on TurtleDexPaths which are used as part of the URL path.
// Paths within the query have to be escaped with url.PathEscape.
func escapeTurtleDexPath(siaPath modules.TurtleDexPath) string {
	sp := siaPath.String()
...
func (c *Client) RenterFileDeleteRootPost(siaPath modules.TurtleDexPath) (err error) {
	sp := escapeTurtleDexPath(siaPath)
...
func (c *Client) RenterFileDeletePost(siaPath modules.TurtleDexPath) (err error) {
	sp := escapeTurtleDexPath(siaPath)
...
// destination on disk.
func (c *Client) RenterDownloadGet(siaPath modules.TurtleDexPath, destination string, offset, length uint64, async bool, disableLocalFetch bool, root bool) (modules.DownloadID, error) {
	sp := escapeTurtleDexPath(siaPath)
	values := url.Values{}
...
// specific host.
func (c *Client) RenterBackupsOnHost(host types.TurtleDexPublicKey) (ubs api.RenterBackupsGET, err error) {
	values := url.Values{}
...
// RenterCreateBackupPost creates a backup of the TurtleDexFiles of the renter and
// uploads it to hosts.
...
// RenterCreateLocalBackupPost creates a local backup of the TurtleDexFiles of the
// renter.
//
...
// file.
func (c *Client) RenterDownloadFullGet(siaPath modules.TurtleDexPath, destination string, async, root bool) (modules.DownloadID, error) {
	sp := escapeTurtleDexPath(siaPath)
	values := url.Values{}
	values.Set("destination", destination)
...
func (c *Client) RenterDownloadHTTPResponseGet(siaPath modules.TurtleDexPath, offset, length uint64, disableLocalFetch, root bool) (modules.DownloadID, []byte, error) {
	sp := escapeTurtleDexPath(siaPath)
	values := url.Values{}
	values.Set("offset", fmt.Sprint(offset))
	values.Set("length", fmt.Sprint(length))
...
// It passes the `root=true` flag to indicate an absolute path.
func (c *Client) RenterFileRootGet(siaPath modules.TurtleDexPath) (rf api.RenterFile, err error) {
	sp := escapeTurtleDexPath(siaPath)
...
func (c *Client) RenterFileGet(siaPath modules.TurtleDexPath) (rf api.RenterFile, err error) {
	sp := escapeTurtleDexPath(siaPath)
...
func (c *Client) RenterRenamePost(siaPathOld, siaPathNew modules.TurtleDexPath, root bool) (err error) {
	spo := escapeTurtleDexPath(siaPathOld)
	values := url.Values{}
...
// stream.
func (c *Client) RenterStreamGet(siaPath modules.TurtleDexPath, disableLocalFetch, root bool) (resp []byte, err error) {
	values := url.Values{}
	values.Set("disablelocalfetch", fmt.Sprint(disableLocalFetch))
	values.Set("root", fmt.Sprint(root))
	sp := escapeTurtleDexPath(siaPath)
...
// of data as a stream.
func (c *Client) RenterStreamPartialGet(siaPath modules.TurtleDexPath, start, end uint64, disableLocalFetch, root bool) (resp []byte, err error) {
	values := url.Values{}
	values.Set("disablelocalfetch", fmt.Sprint(disableLocalFetch))
	values.Set("root", fmt.Sprint(root))
	sp := escapeTurtleDexPath(siaPath)
...
func (c *Client) RenterSetRepairPathPost(siaPath modules.TurtleDexPath, newPath string) (err error) {
	sp := escapeTurtleDexPath(siaPath)
	values := url.Values{}
...
// stuck.
func (c *Client) RenterSetFileStuckPost(siaPath modules.TurtleDexPath, root, stuck bool) (err error) {
	sp := escapeTurtleDexPath(siaPath)
	values := url.Values{}
...
func (c *Client) RenterUploadPost(path string, siaPath modules.TurtleDexPath, dataPieces, parityPieces uint64) (err error) {
...
func (c *Client) RenterUploadForcePost(path string, siaPath modules.TurtleDexPath, dataPieces, parityPieces uint64, force bool) (err error) {
	sp := escapeTurtleDexPath(siaPath)
	values := url.Values{}
...
func (c *Client) RenterUploadDefaultPost(path string, siaPath modules.TurtleDexPath) (err error) {
	sp := escapeTurtleDexPath(siaPath)
	values := url.Values{}
	values.Set("source", path)
	err = c.post(fmt.Sprintf("/renter/upload/%s", sp), values.Encode(), nil)
...
func (c *Client) RenterUploadStreamPost(r io.Reader, siaPath modules.TurtleDexPath, dataPieces, parityPieces uint64, force bool) error {
	sp := escapeTurtleDexPath(siaPath)
	values := url.Values{}
	values.Set("datapieces", strconv.FormatUint(dataPieces, 10))
	values.Set("paritypieces", strconv.FormatUint(parityPieces, 10))
...
// corrupted.
func (c *Client) RenterUploadStreamRepairPost(r io.Reader, siaPath modules.TurtleDexPath) error {
	sp := escapeTurtleDexPath(siaPath)
	values := url.Values{}
...
// renter
func (c *Client) RenterDirCreatePost(siaPath modules.TurtleDexPath) (err error) {
	sp := escapeTurtleDexPath(siaPath)
...
func (c *Client) RenterDirCreateWithModePost(siaPath modules.TurtleDexPath, mode os.FileMode) (err error) {
	sp := escapeTurtleDexPath(siaPath)
...
func (c *Client) RenterDirDeleteRootPost(siaPath modules.TurtleDexPath) (err error) {
	sp := escapeTurtleDexPath(siaPath)
...
// for the renter
func (c *Client) RenterDirDeletePost(siaPath modules.TurtleDexPath) (err error) {
	sp := escapeTurtleDexPath(siaPath)
...
// renter
func (c *Client) RenterDirRenamePost(siaPath, newTurtleDexPath modules.TurtleDexPath) (err error) {
	sp := escapeTurtleDexPath(siaPath)
	nsp := escapeTurtleDexPath(newTurtleDexPath)
...
func (c *Client) RenterDirRootGet(siaPath modules.TurtleDexPath) (rd api.RenterDirectory, err error) {
	sp := escapeTurtleDexPath(siaPath)
...
func (c *Client) RenterDirGet(siaPath modules.TurtleDexPath) (rd api.RenterDirectory, err error) {
	sp := escapeTurtleDexPath(siaPath)
	err = c.get(fmt.Sprintf("/renter/dir/%s", sp), &rd)
	return
}

// RenterValidateTurtleDexPathPost uses the /renter/validatesiapath endpoint to
// validate a potential siapath
//
// NOTE: This function specifically takes a string as an argument not a type
// TurtleDexPath
func (c *Client) RenterValidateTurtleDexPathPost(siaPathStr string) (err error) {
...
func (c *Client) RenterFuseMount(mount string, siaPath modules.TurtleDexPath, opts modules.MountOptions) (err error) {
	sp := escapeTurtleDexPath(siaPath)
	values := url.Values{}
...
func (c *Client) RenterBubblePost(siaPath modules.TurtleDexPath, force, recursive bool) (err error) {
