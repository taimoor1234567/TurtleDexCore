...
// create TurtleDex nodes.

var (
	// AllModulesTemplate is a template for a TurtleDex node that has all modules
	// enabled.
	...
	// FeeManagerTemplate is a template for a TurtleDex node that has a functioning
	...
	// GatewayTemplate is a template for a TurtleDex node that has a functioning
	...
	// HostTemplate is a template for a TurtleDex node that has a functioning host.
	...
	// MinerTemplate is a template for a TurtleDex node that has a functioning miner.
	...
	// RenterTemplate is a template for a TurtleDex node that has a functioning
	...
	// WalletTemplate is a template for a TurtleDex node that has a functioning
