...
// TestThreadGroupTurtleDexExample tries to use a thread group as it might be
// expected to be used by a module of TurtleDex.
func TestThreadGroupTurtleDexExample(t *testing.T) {
	if testing.Short() {
		t.SkipNow()
	}
	t.Parallel()
