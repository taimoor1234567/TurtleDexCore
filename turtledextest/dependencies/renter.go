...
// DependencyDisableCloseUploadEntry prevents TurtleDexFileEntries in the upload code
// from being closed.
type DependencyDisableCloseUploadEntry struct {
	modules.ProductionDependencies
}

// Disrupt prevents TurtleDexfileEntries in the upload code from being closed.
...
// DependencyFailUploadStreamFromReader prevents TurtleDexFileEntries in the upload code
// from being closed.
