...
type (
	...
	// DependencyDisableHostTurtleDexmux will disable siamux in the host.
	DependencyDisableHostTurtleDexmux struct {
		modules.ProductionDependencies
	}
...
// Disrupt returns true if the correct string is provided.
func (d *DependencyDisableHostTurtleDexmux) Disrupt(s string) bool {
	return s == "DisableHostTurtleDexmux"
}
