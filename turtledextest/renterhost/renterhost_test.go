...
func (stubHostDB) IncrementSuccessfulInteractions(types.TurtleDexPublicKey) error { return nil }
func (stubHostDB) IncrementFailedInteractions(types.TurtleDexPublicKey) error     { return nil }
